...
=head2 L<DBIx::Class::Manual::Tutorial>

Builds on the Catalyst tutorial. Step-by-step guide.

=head2 L<DBIx::Class::Manual::Cookbook>

Will contain 'howto' recipes...

=head2 L<DBIx::Class::Manual::Templates>

Will contain cut-and-paste examples of templates to use with FormHandler
