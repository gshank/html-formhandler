...
Note that this script is part of the L<HTML::FormHandler::Model::DBIC> package,
...
Create a Form, subclassed from HTML::FormHandler::Model::DBIC
    ...
    has action => ( is => 'rw', isa => 'Str', default => '/form/' );
...
form, then you will also need a deflation to reformat
