...
These methods call the _localize method, which is applied by L< HTML::FormHandler::TraitFor::I18N >,
and uses Locale::MakeText. You can also use duck_type classes for localization.
