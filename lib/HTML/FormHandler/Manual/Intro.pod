...
The DBIC model will save form fields automatically to the database, will
...
It can automatically handle fields for a number of relationships, using
the compound field, L<HTML::FormHandler::Field::Compound>, and the
repeatable field, L<HTML::FormHandler::Field::Repeatable>.
...
You can render a field using a template. For an example of an input field:
...
(See L<HTML::FormHandler::Manual::Rendering> and L<HTML::FormHandler::Manual::Templates>
