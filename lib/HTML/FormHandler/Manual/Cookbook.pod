...
Or you can use the 'empty_select' attribute on your field:

    has_field 'country' => ( type => 'Select', empty_select => '-- Choose --' );
...
Use 'id_method' to give your fields a different format 'id':
